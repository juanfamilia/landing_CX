            ...
            {siteData.sectors.industries.map((industry) => (
              <motion.div key={industry.id} variants={fadeInUp}>
                <Card className="siete-card h-full text-center group">
                  ...
                  <h3 className="mb-4 text-2xl font-bold" style={{ color: '#2563eb !important', fontWeight: '800' }}>{industry.title}</h3>
                  <p className="font-semibold leading-relaxed mb-4" style={{ color: '#3b82f6 !important', fontWeight: '600' }}>{industry.description}</p>
