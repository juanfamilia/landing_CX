            ...
            {siteData.sectors.industries.map((industry) => (
              <motion.div key={industry.id} variants={fadeInUp}>
                <Card className="siete-card h-full text-center group">
                  ...
                  <h3 className="mb-4 text-2xl force-blue-card-title">{industry.title}</h3>
                  <p className="leading-relaxed mb-4 force-blue-text">{industry.description}</p>
            ...
            >
              {siteData.finalCta.features.map((feature, index) => (
                <div key={index} className="flex items-center justify-center space-x-4">
                  <Icon name="CheckCircle" className="w-8 h-8 force-green-icon" />
          ...
          <div className="grid md:grid-cols-3 gap-8 items-center">
            ...
            <div className="text-center">
              <div className="space-y-2">
                ...
                <div className="text-lg force-blue-subtitle">
